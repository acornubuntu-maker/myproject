...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            <nav class="h-16 px-6 flex items-center justify-between shadow-md fixed top-0 left-0 right-0 z-50" style="background-color:#123456;">
              ...
              <div class="flex items-center gap-4">
                @auth
                  <div class="relative">
                    <button id="profile-toggle" class="flex items-center gap-2 p-2 text-white hover:bg-white/10 rounded-lg" type="button">
                      <div class="w-8 h-8 rounded-full flex items-center justify-center" style="background-color:#fedcba;">
